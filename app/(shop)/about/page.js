  ...
  return (
    <main className="overflow-hidden">
      ...
      <section className="flex flex-col  items-center justify-between min-h-screen">
        ...
        <div className="flex  text-text-color-3 bg-bg-color-5 font-lobster text-xl text-center p-3  mb-5 w-3/4">
        ...
        <div className="flex  text-text-color-5 bg-bg-color-3 font-lobster text-xl text-center p-3 mb-5 w-3/4 ">
        ...
        <div className="flex bg-bg-color-5  text-text-color-3 font-lobster text-xl text-center p-3 mb-5 w-3/4">
